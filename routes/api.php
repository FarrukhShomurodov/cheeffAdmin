...
Route::group(['prefix' => 'v1', 'middleware' => ['block.ip']], function () {
    ...
    //Oauth
    Route::get('/oauth/proid/{isMobileOrWeb}/login', [LoginController::class, 'redirectToProId']);
    Route::get('/oauth/proid/{isMobileOrWeb}/callback', [LoginController::class, 'handleProIdCallback']);

    //Get user data from oauth
    Route::post('get-proid-user', [LoginController::class, 'changeCodeToUser'])->middleware('get.user.by.code');
